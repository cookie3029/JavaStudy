...
class IPhone implements Phone, Mobile {
	...
	public void sendSMS(Contact contact) {
		System.out.print(contact.name + "님께 보낼 메세지를 입력하세요>> ");
		msg = sc.nextLine();
		
		System.out.println(contact.name + "님께 보낸메세지를 확인합니다.");
	...
	public void sendCall(Contact contact) {
		System.out.println(contact.name + "님, " + contact.mobileNo + " 로 전화를 걸고 있습니다...");
	}
